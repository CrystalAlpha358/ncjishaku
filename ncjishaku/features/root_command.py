...
"""
ncjishaku.features.root_command
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

The ncjishaku root command.
...
from ncjishaku.math import natural_size
from ncjishaku.modules import package_version
...
class RootCommand(Feature):
    ...
    async def jsk_tasks(self, ctx: ContextA):
        """
        Shows the currently running ncjishaku tasks.
        """
