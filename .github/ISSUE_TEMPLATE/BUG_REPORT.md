...
- [ ] I have updated nextcord and ncjishaku to the latest available versions and have confirmed that this issue is still present
...
<!-- Post information both about your ncjishaku AND nextcord version here -->
<!-- You can get information about nextcord by running `python -m nextcord -v` -->
<!-- You can get your ncjishaku version by running `pip show ncjishaku` -->
